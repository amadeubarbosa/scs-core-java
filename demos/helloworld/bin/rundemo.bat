...
SET CLASSPATH="%SCS_HOME%\avalon-framework-4.1.5.jar;%SCS_HOME%\jacorb-2.3.0.jar;%SCS_HOME%\logkit-1.2.jar;%SCS_HOME%\scs-idl-jacorb-1.2-SNAPSHOT.jar;%SCS_HOME%\scs-core-1.2.1.3.jar;%SCS_HOME%\scs-demos-helloworld-1.2.1.3.jar"
